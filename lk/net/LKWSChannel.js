...
class LKChannel extends WSChannel {
  ...
  async asyRegister(ip, port, uid, did, venderDid, pk, checkCode, name, description, introducerDid) {
    const msg = { uid, did, venderDid, pk, checkCode, name, description, introducerDid }
